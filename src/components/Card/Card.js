// This component represents a card layout for displaying media details,including title, type, cover image, 
// stats, description, cast, crew, and access information.
import React from "react"; //import the React library into the file.
import StarIcon from "../../assets/StarReviewIcon.jpg"; //Importing star image that use to demonstrate the rating using star
  ...
  return (
    <div className="card">
      ...
      <div className="card-stats">
        ...
        <p className="card-span-gray">({props.reviewCount}) &nbsp;</p>
      </div>
